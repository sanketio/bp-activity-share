...
class BP_Activity_Share_Public {
    ...
    public function bp_activity_share_button_render() {
        ...
        if ( true == $this->bp_activity_share_can_share() ) {
            ?>
            <a href="<?php $this->bp_activity_share_link(); ?>" class="button bp-activity-share bp-primary-action" title="<?php esc_attr_e( 'Share this activity', 'buddypress' ); ?>"><?php printf( __( 'Share <span>%s</span>', 'buddypress' ), $this->bp_activity_share_get_share_count() ); ?></a>
            <?php
        }
    ...
    private function bp_activity_share_can_share() {
        ...
        if ( ! in_array( $activity_type, $activity_supported_types ) ) {
            $can_share = false;
        }
    ...
    private function bp_activity_share_link() {
        ...
        echo $this->bp_get_activity_share_link();
